...
def ChecklistAllCharacter(user_achievements):
    for i in range(len(CharactersAchievements)):
        if i % 14 == 0:
            char = CharactersAchievements[i]
        elif i % 14 == 8:
            continue
        elif i % 14 == 9 and CharactersAchievements[i] in user_achievements:
            UserPostIt[char].append(2)
        elif i % 14 == 9 and CharactersAchievements[i-1] in user_achievements:
            UserPostIt[char].append(1)
        elif CharactersAchievements[i] in user_achievements:
            UserPostIt[char].append(2)
        else:
